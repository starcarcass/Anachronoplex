...
def show_segment_p(pix, segname, col, p, flush=False):
...
clear_segment(pix)
show_segment(pix, 'b', [255,0,0], True)
...
for rep in range(rep_n):
    c = int(float(rep)*255.0/float(rep_n))
    spinner(pix, [255,0,c])
