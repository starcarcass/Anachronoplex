...
animate_gif(pix, "./draw9.gif", 0.01)
animate_gif(pix, "./draw8.gif", 0.01)
animate_gif(pix, "./draw7.gif", 0.01)
animate_gif(pix, "./draw6.gif", 0.01)
animate_gif(pix, "./draw5.gif", 0.01)
animate_gif(pix, "./draw4.gif", 0.01)
animate_gif(pix, "./draw3.gif", 0.01)
animate_gif(pix, "./draw2.gif", 0.01)
animate_gif(pix, "./draw1.gif", 0.01)
animate_gif(pix, "./draw0.gif", 0.01)
